...
/**
 * Cache' Java Class Generated for class Parking.Owner on version Cache for Windows (x86-32) 2015.2 (Build 664U) Fri Jul 10 2015 13:22:27 EDT.<br>
 *
 * @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner</A>
**/

public class Owner extends Parking.Person {
    private static final long serialVersionUID = 466;
    private static String CACHE_CLASS_NAME = "Parking.Owner";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>Parking.Owner.open</code> instead!</br></p>
           <p>
    ...
    */
    public Owner (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public Owner (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
        super (((com.intersys.cache.SysDatabase)db).newCacheObject (CACHE_CLASS_NAME,initstr));
    }
    /**
       Creates a new instance of object "Parking.Owner" in Cache
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public Owner (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    ...
    * objects must be instances of <code>Parking.Owner</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>Parking.Owner</code> or of
      any of its subclasses. Cast to <code>Parking.Owner</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #Owner(com.intersys.objects.Database)
     */
    ...
    * to open all instances of class Parking.Owner
    ...
    */
    ...
    /**
       Returns class name of the class Parking.Owner as it is in
   ...
   */
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, Owner.class);
    }
    public static void checkGaragesValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>Garages</code>.
       <Description>
       @return current value of <code>Garages</code> represented as
       ...
       @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#Garages"> Garages</A>
    */
    public com.intersys.classes.RelationshipObject getGarages()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("Garages",true);
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
	...
	Check to see if an OID exists in the extent of this class...</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%Exists"> Method %Exists</A>
    */
    ...
    */
	...
	Check to see if an ID exists in the extent of this class...</p>
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%IsA"> Method %IsA</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%KillExtent"> Method %KillExtent</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%ObjectIsNull"> Method %ObjectIsNull</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     <p>Runs method GaragesGetObject in Cache.</p>
     default argument force set to 0
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see #GaragesGetObject(java.lang.Integer)
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#GaragesGetObject"> Method GaragesGetObject</A>
    */
    public com.intersys.objects.Oid GaragesGetObject () throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[0];
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("GaragesGetObject",args,com.intersys.objects.Database.RET_PRIM);
        return res.getOid();
    }
    /**
     <p>Runs method GaragesGetObject in Cache.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#GaragesGetObject"> Method GaragesGetObject</A>
    */
    public com.intersys.objects.Oid GaragesGetObject (java.lang.Integer force) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
    ...
    /**
     <p>Runs method GaragesGetObjectId in Cache.</p>
     default argument force set to 0
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see #GaragesGetObjectId(java.lang.Integer)
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#GaragesGetObjectId"> Method GaragesGetObjectId</A>
    */
    public java.lang.String GaragesGetObjectId () throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[0];
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("GaragesGetObjectId",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method GaragesGetObjectId in Cache.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#GaragesGetObjectId"> Method GaragesGetObjectId</A>
    */
    public java.lang.String GaragesGetObjectId (java.lang.Integer force) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(force);
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("GaragesGetObjectId",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    ...
    /**
     <p>Runs method GaragesIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param value represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#GaragesIsValid"> Method GaragesIsValid</A>
    */
    public static void GaragesIsValid (com.intersys.objects.Database db, java.lang.String value) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(value);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"GaragesIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#IDKEYOpen"> Method IDKEYOpen</A>
    */
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
     ...
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#Populate"> Method Populate</A>
    */
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
    ...
    */
    ...
    /**
     ...
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#PopulateSerial"> Method PopulateSerial</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://My:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=USER&CLASSNAME=Parking.Owner#Random"> Method Random</A>
    */
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "Parking.Owner_Extent", 0, 0);
    }
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("Parking", "Owner", 4, batch, con, nolock);
